...
controls.maxDistance = 30; // How far they can go
controls.maxPolarAngle = Math.PI / 2.8; // Limitation
controls.update();
...
```
// Lighting
var spotLight = new THREE.SpotLight("#FFC19E") // Color
spotLight.position.set( 0.4982 , 70.32728 , 90.7961  ); 
spotLight.power = 5; // Brightness
